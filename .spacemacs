  ...
  (setq-default
   ...
   '(
     ...
     (wakatime :variables
               ...
               wakatime-cli-path "/nix/store/f8r1ingy37p2ajj12m97l0ix32pvl0vq-user-environment/bin/wakatime-cli")
